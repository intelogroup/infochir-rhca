      ...
      <div className="min-h-screen bg-gradient-to-br from-white to-gray-50">
        ...
        <section className="relative overflow-hidden py-16 sm:py-32">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-2xl sm:text-5xl font-bold bg-gradient-to-r from-primary via-secondary to-ocean bg-clip-text text-transparent mb-4 sm:mb-6">
                À propos d'INFOCHIR/RHCA
              </h1>
              <p className="text-base sm:text-xl text-gray-600 leading-relaxed px-2">
        ...
        <section className="py-8 sm:py-16 bg-white">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              className="grid gap-4 sm:gap-8 md:grid-cols-2 lg:grid-cols-4"
            >
              <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
                <Target className="w-8 h-8 sm:w-12 sm:h-12 text-primary mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Notre Mission</h3>
              ...
              <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
                <BookOpen className="w-8 h-8 sm:w-12 sm:h-12 text-primary mb-3 sm:mb-4" />
              ...
              <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
                <Users className="w-8 h-8 sm:w-12 sm:h-12 text-primary mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Formation Continue</h3>
                <p className="text-sm sm:text-base text-gray-600">
              ...
              <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
                <Award className="w-8 h-8 sm:w-12 sm:h-12 text-primary mb-3 sm:mb-4" />
        ...
        <section className="py-8 sm:py-16 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-xl sm:text-3xl font-bold text-center text-primary mb-6 sm:mb-12">Nos Services</h2>
              <div className="grid gap-4 sm:gap-8 md:grid-cols-2">
                <div className="p-4 sm:p-8 rounded-2xl bg-white shadow-lg shadow-primary/5 hover:shadow-xl transition-shadow border border-gray-100">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Publications Scientifiques</h3>
                ...
                <div className="p-4 sm:p-8 rounded-2xl bg-white shadow-lg shadow-primary/5 hover:shadow-xl transition-shadow border border-gray-100">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Base de Données Médicale</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
