      ...
      <div className="min-h-screen bg-gradient-to-br from-white to-gray-50">
        ...
        <section className="relative overflow-hidden py-20 sm:py-32">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-primary via-secondary to-ocean bg-clip-text text-transparent mb-6">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Formation Continue</h3>
                <p className="text-gray-600">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <div className="p-8 rounded-2xl bg-white shadow-lg shadow-primary/5 hover:shadow-xl transition-shadow border border-gray-100">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">Publications Scientifiques</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Publication d'articles scientifiques revus par des pairs dans le domaine de la chirurgie et de l'anesthésiologie.
                  </p>
                </div>
                <div className="p-8 rounded-2xl bg-white shadow-lg shadow-primary/5 hover:shadow-xl transition-shadow border border-gray-100">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">Base de Données Médicale</h3>
                  <p className="text-gray-600 leading-relaxed">
