  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-[#F1F0FB]">
        <div className="container max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8 pt-20">
          ...
          <div className="text-center mb-6 sm:mb-12 animate-fade-up">
            <img 
              ...
              className="h-12 w-12 sm:h-20 sm:w-20 lg:h-24 lg:w-24 mx-auto mb-3 sm:mb-6 object-contain"
            />
          ...
          <Tabs defaultValue="articles" className="mb-6">
            <TabsList className="w-full justify-start border-b rounded-none p-0 h-auto overflow-x-auto">
              <TabsTrigger 
                value="articles" 
                className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base whitespace-nowrap"
              >
                Articles
              </TabsTrigger>
              <TabsTrigger 
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-md border border-gray-100 hover:shadow-lg transition-shadow mt-6 sm:mt-8">
