...
export const AtlasBackfillPanel: React.FC = () => {
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Remplissage Articles Atlas
        </CardTitle>
        <CardDescription>
          Analyser et ajouter automatiquement les articles Atlas manquants dans la base de données
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            Cette fonction va analyser les PDFs Atlas stockés et créer automatiquement les entrées manquantes dans la base de données avec du contenu généré par IA.
          </div>
        </div>
