  ...
  const { 
    ...
    queryFn: async () => {
      ...
      try {
        ...
        // Extract total downloads; the stats helper may return snake_case (view shape)
        // or camelCase (typed shape), so accept both.
        const raw = downloadStats as unknown as Record<string, unknown> | null;
