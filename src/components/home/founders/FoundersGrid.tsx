...
export const FoundersGrid = ({ 
  ...
  // Adaptive grid class based on number of founders
  const gridColClass = founders.length === 1 && isDeceased ? 
    'md:col-span-2 lg:col-span-3 xl:col-span-4' : '';
  
  const innerGridClass = founders.length > 1 && isDeceased ? 
  ...
  return (
    <>
      ...
      <div className={`col-span-1 ${gridColClass} grid grid-cols-1 ${innerGridClass} gap-8`}>
