    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-4xl h-[95vh] max-h-[95vh] p-0 overflow-hidden bg-card flex flex-col">
        <div className="bg-muted p-3 sm:p-6 flex-shrink-0">
          <DialogHeader>
            <DialogTitle className="text-lg sm:text-xl md:text-2xl font-bold text-foreground line-clamp-2 leading-tight">
              {article.title}
            </DialogTitle>
        ...
        <ScrollArea className="flex-1 px-3 sm:px-6 overflow-y-auto" style={{ scrollbarWidth: 'thin' }}>
          ...
          <div className="py-3 sm:py-6 space-y-4 sm:space-y-6">
            ...
            <div className="bg-muted p-3 sm:p-4 rounded-lg">
              <div className="text-xs sm:text-sm text-foreground/80 whitespace-pre-line font-medium break-words">
                {getPublicationInfo(article)}
              </div>
            </div>

            <div className="flex flex-col gap-3 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="prose prose-sm max-w-none">
              <h3 className="text-base sm:text-lg font-semibold text-foreground mb-2">Résumé</h3>
            ...
            <div className="flex flex-wrap gap-3 sm:gap-8 text-xs sm:text-sm border-t border-b py-3 sm:py-4 text-muted-foreground">
              <div className="flex items-center gap-2">
        ...
        <div className="bg-card border-t border-border p-3 sm:p-4 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 shadow-sm flex-shrink-0">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-10 sm:h-9 px-4 font-medium hover:bg-muted transition-colors duration-200 text-sm"
