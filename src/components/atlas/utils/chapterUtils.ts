...
export const filterComingChapters = (chapters: AtlasChapter[]): AtlasChapter[] => {
  return chapters.filter(chapter => chapter.status === "coming-soon" || chapter.status === "coming");
};

export const sortChaptersByDate = (chapters: AtlasChapter[]): AtlasChapter[] => {
  return [...chapters].sort((a, b) => {
    const aDate = a.lastUpdated || a.lastUpdate || a.publicationDate;
    const bDate = b.lastUpdated || b.lastUpdate || b.publicationDate;
