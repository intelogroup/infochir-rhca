...
const devCSP = `default-src 'self'; connect-src 'self' wss://*.lovable.ai https://*.lovable.ai https://*.supabase.co wss://*.supabase.co https://*.stripe.com https://*.netlify.app vitals.vercel-insights.com https://ingesteer.services-prod.nsvcs.net; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.stripe.com https://m.stripe.network https://cdn.gpteng.co https://vitals.vercel-insights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; frame-src 'self' https://*.stripe.com https://*.supabase.co; media-src 'self' data:; object-src 'none'; worker-src 'self' blob:;`;
